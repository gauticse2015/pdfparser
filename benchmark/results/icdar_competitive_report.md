...
**Incomplete board:** this dump is **pdfparser-only** (**peers=1**). A solo board is **not** a multi-peer rank. Do **not** claim ICDAR #1 from this file. The honest multi-peer table is in the repo README (pdfparser **#2** on detection F1 vs Camelot auto). Gate labels: `docs/STATUS.md`.
