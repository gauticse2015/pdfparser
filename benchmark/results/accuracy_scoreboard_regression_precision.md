...
|-----:|---------|--------:|----------:|------------:|--------:|---:|
| 1 | **pdfparser** ← **ours** | 0.983 | 0.897 | 0.917 | 89.964 | 6.7 |
| 2 | **camelot_lattice** | 0.900 | 0.897 | 0.833 | 83.233 | 46.8 |
| 3 | **camelot_auto** | 0.900 | 0.897 | 0.833 | 81.291 | 384.5 |
| 4 | **pdfplumber** | 0.894 | 0.897 | 0.833 | 89.780 | 10.0 |

### Overall product score (text+tables+objects)

| Rank | Library | overall | text F1 | table cell F1 | ms |
|-----:|---------|--------:|--------:|--------------:|---:|
| 1 | **pdfparser** ← **ours** | 89.964 | 0.962 | 0.983 | 6.7 |
| 2 | **pdfplumber** | 89.780 | 0.962 | 0.894 | 10.0 |
| 3 | **camelot_lattice** | 83.233 | 0.513 | 0.900 | 46.8 |
| 4 | **camelot_auto** | 81.291 | 0.667 | 0.900 | 384.5 |
...
|---------|--------:|-----:|--------:|-----:|------:|----------:|--------:|--------:|---:|
| pdfparser | 89.964 | 96.154 | 0.962 | — | 88.872 | 0.897 | 0.983 | 100.000 | 6.7 |
| pdfplumber | 89.780 | 96.154 | 0.962 | — | 88.655 | 0.897 | 0.894 | 100.000 | 10.0 |
| camelot_lattice | 83.233 | 51.282 | 0.513 | — | 88.872 | 0.897 | 0.900 | — | 46.8 |
| camelot_auto | 81.291 | 66.667 | 0.667 | — | 83.872 | 0.897 | 0.900 | — | 384.5 |
...
|---------|--:|----------:|------------:|--------:|------------:|
| pdfparser | 12 | 0.972 | 0.917 | 0.983 | 96.278 |
...
| `75_prose_not_stream` | 15.0 | 85.0 | 15.0 | 100.0 |
| `76_caption_not_table` | 85.1 | 85.1 | 90.1 | 90.1 |
...
| `81_phantom_verticals` | 67.0 | 67.0 | 72.0 | 72.0 |
...
| `81_phantom_verticals` | 0.800 | 0.800 | 0.800 | 0.800 |
...
|-----:|---------|----------:|------------:|--------:|------------:|---:|
| 1 | **pdfparser** | 0.897 | 0.917 | 0.983 | 88.872 | 6.7 |
| 2 | **camelot_lattice** | 0.897 | 0.833 | 0.900 | 88.872 | 46.8 |
| 3 | **camelot_auto** | 0.897 | 0.833 | 0.900 | 83.872 | 384.5 |
| 4 | **pdfplumber** | 0.897 | 0.833 | 0.894 | 88.655 | 10.0 |
