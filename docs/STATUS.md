...
As-built hardening bible: [`design-zero-regression-hardening.md`](design-zero-regression-hardening.md).  
...
| README **0.738** is live, not a freeze | Later `real_structure_latest.json` core number; not a new freeze artifact |
...
| **GATE-3** shape / topology | **NOT green** | Core freeze shape exact **0.533** (`g2.json`); later live full-suite shape ~0.58 still below honest G3 floors | GATE-3 PASS |
...
| **GATE-5** industry / production polish | **NOT green** | `g3_industry.json` phase4/5 **INVALID**; freeze README must not say phase5 PASS | GATE-5 PASS; production-ready |
...
| Artifact | Role | Core cell (Auto) | Status |
|----------|------|-----------------:|--------|
| [`benchmark/real_track/freezes/g2.json`](../benchmark/real_track/freezes/g2.json) | **Steady freeze / regression lock** | **0.637** | Active |
| README / `real_structure_latest.json` core | Later **live** snapshot (2026-07-19) | **0.738** | Not a freeze. Do not treat as g2 replacement |
