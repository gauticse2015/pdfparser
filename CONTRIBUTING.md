...
- **Table engine**: product Auto/Full use **Engine V2** (`docs/design-table-engine-v2.md`). Rollback: `TableOptions.legacy_router = true`. Gate PASS/FAIL: `docs/STATUS.md` only - do not claim GATE-3/4/5. Do not tune thresholds on ICDAR.
